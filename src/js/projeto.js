const projetos = {
  ...
  jarvis: { codigo: 'PROJECT / 007', nome: 'JARVIS', tipo: 'LOCAL INTELLIGENCE', resumo: 'Uma camada de inteligência local para ouvir, interpretar e agir com controle.', descricao: 'Assistente de voz local para Linux com wake word, Whisper, interpretação opcional via Ollama, síntese Piper e execução controlada de comandos registrados.', stack: ['Python', 'Whisper', 'Ollama', 'Piper'], capacidades: ['Wake word local', 'Transcrição em português', 'Comandos registrados'], direcao: 'Interface de sala de comando: escura, precisa e viva, como um sistema que está sempre escutando.', execucao: 'Instale dependências de áudio, configure o modelo local e inicie o serviço.', comando: 'python -m jarvis', guia: '#', github: 'https://github.com/lucaspwalter/jarvis', tema: 'jarvis', visual: 'jarvis', status: 'EM DESENVOLVIMENTO' },
  brasilium: { codigo: 'PROJECT / 008', nome: 'Brasilium Browser', tipo: 'PERSONAL BROWSER', resumo: 'Um navegador pessoal com identidade própria e foco em eficiência.', descricao: 'Build baseado em Chromium com branding Brasilium e ajustes de execução para reduzir consumo sem remover recursos essenciais.', stack: ['C++', 'Chromium', 'Linux', 'AppImage'], capacidades: ['Identidade Brasilium', 'Perfil pessoal persistente', 'Execução otimizada'], direcao: 'Menos ruído, mais controle: um navegador moldado para uso diário.', execucao: 'Baixe o AppImage, conceda permissão e execute.', comando: 'chmod +x Brasilium.AppImage && ./Brasilium.AppImage', guia: '#', github: 'https://github.com/lucaspwalter/helium-performance', tema: 'brasil', visual: 'brasilium', status: 'EM DESENVOLVIMENTO' }
};
