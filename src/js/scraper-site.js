...
document.getElementById('runScan').addEventListener('click', (event) => { event.currentTarget.textContent = '✓ busca executada'; log.innerHTML = '> coletor iniciado / fontes: 04 / status: concluído<span>_</span>'; });
