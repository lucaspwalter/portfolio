...
people.forEach((person) => person.addEventListener('click', () => {
  ...
  detail.textContent = `${person.querySelector('strong').firstChild.textContent.trim()}: seis sinais combinados. Pontuação ${person.querySelector('i').textContent}/100. Abra o painel para investigar o contexto.`;
}));
