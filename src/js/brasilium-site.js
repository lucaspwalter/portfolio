...
const pointer=new THREE.Vector2();const target=new THREE.Vector2();let dragging=false;let mode=0;const modes=['MODO DE BAIXO USO DE RAM','4 RENDERIZADORES','PROCESSO POR SITE'];
